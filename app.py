...
# Standard imports with safety for installation phase
try:
...
if HAS_FLASK:
    ...
    # Dummy WSGI app to prevent 500 error during pip installation
    def application(environ, start_response):
        start_response('200 OK', [('Content-Type', 'text/html')])
        return [b"<h1>Environment Setup in Progress</h1><p>Please run pip install in cPanel.</p>"]
